  ...
  return (
    ...
    :props.slides.map((slide) => (
        <SwiperSlide key={slide.id}>
            ...
            <img className="carousel-image" src={slide.imageUrl} style={{ objectFit: 'cover', width: '300px', height:'250px'}}/>
        </SwiperSlide>))}          
    </Swiper>
    </div>
  )
