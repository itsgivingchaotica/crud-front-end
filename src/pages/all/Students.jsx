...
return (
   <ErrorBoundary
    ...
    > 
  <div style={{marginTop:"120px", minHeight:'1000vh', width:'100%', backgroundColor:'var(--off-white)'}}>
  ...
  <Typography variant={isMobileScreen ? "h3" : "h1"} sx={{fontFamily:`'Tangerine', sans-serif`, fontWeight:'700', marginTop:'30px'}}>Student Profiles </Typography>
 <Grid item xs={12} md={8} sx={{ display: 'flex', justifyContent: 'space-evenly', alignItems: 'center', textAlign: 'center', marginTop:'-20px'}}>
  <NavLink to="/students/addStudent" style={{ textDecoration: 'none' }}>
    <Button style={{ display: 'flex', alignItems: 'center', color: 'black'}}>
      <Typography variant={isMobileScreen ? "subtitle2" : "h5"} sx={{ fontFamily: `'Ysabeau Infant', sans-serif`, fontWeight: '700', '&:hover': {
          cursor: 'pointer', textShadow: '1px 1px 1px var(--dark-green)'},  }}>
        Quick Add
      </Typography>
