      ...
      {isMobileScreen ? (
        <div className="home">
          <div style={{ color: 'white', transform: 'translateY(100px)', backgroundColor:'rgb(66, 55, 52,0.5)' }}>
             <Typography variant='h5' sx={{fontFamily: `'Manrope', sans-serif`, fontWeight:'700', textShadow: '-1px 1px 0 black, -1px 1px 0 black, -1px 1px 0 black, -1px 1px 0 black', marginTop:'30px', marginLeft:'10px'}}>
          ...
          <Grid container sx={{maxHeight:'50vh', marginLeft:'20px'}}>
            <Grid item xs={6} md={7} style={{ display: 'flex', justifyContent: 'flex-end'}}>
              <div style={{ color: 'white', transform: 'translateY(250px)', backgroundColor:'rgb(66, 55, 52,0.5)'}}>
                <Typography variant='h3' sx={{fontFamily: `'Manrope', sans-serif`, fontWeight:'700', textShadow: '-1px 1px 0 black, -1px 1px 0 black, -1px 1px 0 black, -1px 1px 0 black'}}>
                  Experience software designed to make your academic operations 
