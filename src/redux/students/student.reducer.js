import { FETCH_ALL_STUDENTS, ADD_STUDENT, EDIT_STUDENT, DELETE_STUDENT, SEARCH_STUDENTS_BY_CAMPUS, ADD_BATCH_STUDENT, CLEAR_BATCH_STUDENTS, DELETE_BATCH_STUDENT } from "./student.types";
